...
/*-----------------------------------------------------------------------------------*/
	...
	if ( have_comments() ) :
        ...
        if ( ! empty($comments_by_type['comment']) ) : // if there are normal comments ?>
	        ...
	        <h3 class="comments-title"><?php comments_number(__('No Comments', 'junkie'), __('1 Comment', 'junkie'), __('% Comments', 'junkie')); ?></h3>
	
        	<ol class="commentlist">
            <?php wp_list_comments( 'type=comment&callback=junkie_comment' ); ?>
            </ol>
        ...
        if ( ! empty($comments_by_type['pings']) ) : // if there are pings ?>
			...
			<div class="pings-wrapper">
	    		...
	    		<ol class="pinglist">
	            <?php wp_list_comments( 'type=pings&callback=junkie_list_pings' ); ?>
	            </ol>
            </div>
