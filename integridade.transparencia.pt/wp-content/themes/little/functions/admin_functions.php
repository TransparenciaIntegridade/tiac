...
function css_admin() { ?> 
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/functions/css/admin-style.css" type="text/css" />
	<style type="text/css">
	.lightboxclose { background: url("<?php echo get_template_directory_uri() ?>/functions/images/description-close.png") no-repeat; width: 19px; height: 20px; }
	</style>
	<!--[if IE 8]>
	<style type="text/css">
					...
					<div id="admincp-content">
						...
						<ul id="admincp-mainmenu">
							<?php if(in_array('general',$admincpMainTabs)) { ?>
								<li><a href="#nav-general"><img src="<?php echo get_template_directory_uri() ?>/functions/images/ico-general.png" class="pngfix" alt="" />General Settings</a></li>
							<?php }; ?>
							<?php if(in_array('navigation',$admincpMainTabs)) { ?>
								<li><a href="#nav-navigation"><img src="<?php echo get_template_directory_uri() ?>/functions/images/ico-navigation.png" class="pngfix" alt="" />Navigation</a></li>
							<?php }; ?>
							<?php if(in_array('layout',$admincpMainTabs)) { ?>
								<li><a href="#nav-layout"><img src="<?php echo get_template_directory_uri() ?>/functions/images/ico-layout.png" class="pngfix" alt="" />Layout Settings</a></li>
							<?php }; ?>
							<?php if(in_array('ad',$admincpMainTabs)) { ?>
								<li><a href="#nav-advertisements"><img src="<?php echo get_template_directory_uri() ?>/functions/images/ico-ad.png" class="pngfix" alt="" />Ad Management</a></li>
							<?php }; ?>

							<?php if(in_array('seo',$admincpMainTabs)) { ?>
								<li><a href="#nav-seo"><img src="<?php echo get_template_directory_uri() ?>/functions/images/ico-seo.png" class="pngfix" alt="" />SEO Options</a></li>
							<?php }; ?>
							<?php if(in_array('integration',$admincpMainTabs)) { ?>
								<li><a href="#nav-integration"><img src="<?php echo get_template_directory_uri() ?>/functions/images/ico-integration.png" class="pngfix" alt="" />Integration</a></li>
							<?php }; ?>
							<?php if(in_array('doc',$admincpMainTabs)) { ?>
								<li><a href="#nav-doc"><img src="<?php echo get_template_directory_uri() ?>/functions/images/ico-doc.png" class="pngfix" alt="" />Documentation</a></li>
							<?php }; ?>
