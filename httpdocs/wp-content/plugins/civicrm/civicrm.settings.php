...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://admin_tiac:Tiac_2013**@localhost/tiac_civicrm_fin?new_link=true');
}
...
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/vhosts/transparencia.pt/httpdocs/wp-content/plugins/files/civicrm/templates_c/');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/vhosts/transparencia.pt/httpdocs/wp-content/plugins/files/civicrm/templates_c//mail.log');
// }
