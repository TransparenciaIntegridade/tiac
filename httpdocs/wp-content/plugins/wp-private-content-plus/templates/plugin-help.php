...
<div class="wrap about-wrap">
	...
	<div class="wpexpert-help-tab">
		<div class="feature-section">
			...
			<h2><?php _e( 'What\'s New', 'wppcp' );?></h2>

			<p><?php _e( 'This version introduces Search Restrictions on content types as well as user types. 
			Now you can block certain pages/posts from appearing in search results. Also you can restrict searchable content 
			based on user type such as Guest, Everyone and Members', 'wppcp' ); ?></p>

			<h4><?php _e( 'Search Settings Screen', 'wppcp' );?></h4>
			<div class="wpexpert-help-screenshot">
				<img src="http://www.wpexpertdeveloper.com/wp-content/uploads/2016/01/search_settings_1.png" />
			</div>


			<h4><?php _e( 'Search Restrictions Screen', 'wppcp' );?></h4>
			<div class="wpexpert-help-screenshot">
				<img src="http://www.wpexpertdeveloper.com/wp-content/uploads/2016/01/search_restrictions_1.png" />
			</div>
