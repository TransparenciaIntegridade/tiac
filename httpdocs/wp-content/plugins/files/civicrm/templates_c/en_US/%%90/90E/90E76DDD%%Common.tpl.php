...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contribute/Form/Search/Common.tpl', 1, false),array('block', 'ts', 'CRM/Contribute/Form/Search/Common.tpl', 27, false),array('modifier', 'crmAddClass', 'CRM/Contribute/Form/Search/Common.tpl', 44, false),array('function', 'help', 'CRM/Contribute/Form/Search/Common.tpl', 87, false),)), $this); ?>
...
<tr>
  <td>
    <div class="float-left">
      <label><?php echo $this->_tpl_vars['form']['payment_instrument_id']['label']; ?>
</label> <br />
      <?php echo ((is_array($_tmp=$this->_tpl_vars['form']['payment_instrument_id']['html'])) ? $this->_run_mod_handler('crmAddClass', true, $_tmp, 'twenty') : smarty_modifier_crmAddClass($_tmp, 'twenty')); ?>
...
<br />
 ...
 <br />
  ...
  <td>
    <?php echo $this->_tpl_vars['form']['invoice_id']['label']; ?>
 <br />
