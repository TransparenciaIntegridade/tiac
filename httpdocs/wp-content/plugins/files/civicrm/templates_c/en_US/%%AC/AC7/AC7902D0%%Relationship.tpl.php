...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Page/View/Relationship.tpl', 1, false),array('block', 'crmButton', 'CRM/Contact/Page/View/Relationship.tpl', 35, false),array('block', 'ts', 'CRM/Contact/Page/View/Relationship.tpl', 35, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (! empty ( $this->_tpl_vars['cdType'] )): ?>
...
unset($_smarty_tpl_vars);
 ?>
<?php elseif ($this->_tpl_vars['action'] != 16): ?>   <?php $_smarty_tpl_vars = $this->_tpl_vars;
