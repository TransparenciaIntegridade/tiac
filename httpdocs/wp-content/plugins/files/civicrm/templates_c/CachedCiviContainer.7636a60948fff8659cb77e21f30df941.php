...
class CachedCiviContainer extends Container
{
    ...
    {
        return $this->services['cache.settings'] = \Civi\Core\Container::getBootService('cache.settings');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Civi\Core\Lock\LockManager A Civi\Core\Lock\LockManager instance.
     */
    protected function getLockmanagerService()
    {
        return $this->services['lockmanager'] = \Civi\Core\Container::getBootService('lockManager');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Civi\Core\Paths A Civi\Core\Paths instance.
     */
    protected function getPathsService()
    {
        return $this->services['paths'] = \Civi\Core\Container::getBootService('paths');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \CRM_Core_Config_Runtime A CRM_Core_Config_Runtime instance.
     */
    protected function getRuntimeService()
    {
        return $this->services['runtime'] = \Civi\Core\Container::getBootService('runtime');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Civi\Core\SettingsManager A Civi\Core\SettingsManager instance.
     */
    protected function getSettingsManagerService()
    {
        return $this->services['settings_manager'] = \Civi\Core\Container::getBootService('settings_manager');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \CRM_Core_Permission_Base A CRM_Core_Permission_Base instance.
     */
    protected function getUserpermissionclassService()
    {
        return $this->services['userpermissionclass'] = \Civi\Core\Container::getBootService('userPermissionClass');
    }
    ...
    {
        return $this->services['usersystem'] = \Civi\Core\Container::getBootService('userSystem');
    }
    ...
    {
        return array(
            'civicrm_base_path' => '/var/www/vhosts/transparencia.pt/httpdocs/wp-content/plugins/civicrm/civicrm',
        );
    }
}
