...
<link rel="stylesheet" href="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/assets/css/social-buttons.css" type="text/css" media="all" >
   <link href="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/assets/css/responsivemobilemenu/rmm-css/responsivemobilemenu.css" type="text/css"/>
...
<script src="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/assets/css/style/script/respond.js"></script>
        ...
        <![endif]-->
        <script src="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/assets/css/responsivemobilemenu/rmm-js/responsivemobilemenu.js"</script>
...
<?php 
	$arr=array();
	for($i=0;$i<5;$i++){
		$arr[$i]="http://$_SERVER[HTTP_HOST]/wp-content/themes/wpbootstrap/assets/img/Imagens1/".$i.".png"; //assigning the image location to the array $arr.
	}
...
$arr2=array();
	for($b=0;$b<5;$b++){
		$arr2[$b]="http://$_SERVER[HTTP_HOST]/wp-content/themes/wpbootstrap/assets/img/Imagens2/".$b.".png"; //assigning the image location to the array $arr.
	}
	$random2=rand(1,4); 
...
$arr3=array();
	for($c=0;$c<5;$c++){
		$arr3[$c]="http://$_SERVER[HTTP_HOST]/wp-content/themes/wpbootstrap/assets/img/Imagens3/".$c.".png"; //assigning the image location to the array $arr.
	}
	$random3=rand(1,4); 
...
$arr4=array();
	for($d=0;$d<5;$d++){
		$arr4[$d]="http://$_SERVER[HTTP_HOST]/wp-content/themes/wpbootstrap/assets/img/Imagens4/".$d.".png"; //assigning the image location to the array $arr.
	}
	$random4=rand(1,4); 
...
?>
 ...
 <body data-spy="scroll" data-target=".navbar" onload="showTwitter('twitter-wjs',{width:650,height:530,color:'#ff0000',theme:'dark',element:'div.feed'})">  
...
<!--<div  id="google_translate_element" style="float:right;"></div>-->
			<div class="brick1 logo_container">
					<a href="#" class="nav-item clearfix" style="margin-top:10px;">
						<div class="nav-hover"></div>
                ...
                <nav id="menu-drink">
                    <ul>
                          ...
                          <div class="hidden-phone">
                            <a href="#participa"><i class="fa fa-wrench  fa-2x"style="margin-left:-5px"></i>Participar</a></div>
                            <div class="visible-phone">
                            <a href="/"><i class=" fa-home"></i>Home</a></div>
                        </li>

                        <li class="menu-item">
                        
                            <a href="#sobre"><i class="fa fa-users  fa-lg" ></i><b style="margin-left:5px">Sobre</a></b>
                        </li>
                        

                        <li class="menu-item">
                        <a href="#topicos"><i class="fa fa-bug  fa-lg" ></i><b style="margin-left:5px">Corrupção</a></b>

                      </li>
                        <li class="menu-item">
                            <a href="#noticias"><i class="fa fa-rss fa-lg" ></i><b style="margin-left:5px">Noticias</a></b>
                        </li>
                         
                        <li class="menu-item">
                          <a href="#agenda"><i class="fa fa-calendar fa-lg" ></i><b style="margin-left:5px">Agenda</a></b>
                        </li>
                        <li class="menu-item">
                          <a href="#publicacoes"><i class="fa fa-file-text fa-lg" ></i><b style="margin-left:5px">Publicações</a></b>
                        </li>
                        

                        <li class="menu-item" style="font-family: FontAwesome;">
                          <a href="#provedoria"><i class="fa fa-university fa-lg" ></i><b style="margin-left:5px">Provedoria</a></b>
                        </li>
                        <li class="menu-item" >
                           <a href="#contatos" ><i class="fa fa-envelope fa-lg" ></i><b style="margin-left:5px">Contactos</b></a>
                        </li>
                        <div class="visible-phone">
                        <li class="menu-item">
                          <a href="#" onClick="alert(' © 2014 TIAC. Todos os direitos reservados.')"><i class="fa-edit fa-lg"></i>Créditos</a>
                        </li>
                      </div>
                    </ul>
                </nav>
