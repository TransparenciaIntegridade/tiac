...
<html lang="pt">
  <head>
    ...
    <link href="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/css/bootstrap.min.css" rel="stylesheet">
   <link href="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/css/style1.css" rel="stylesheet">
     <!-- <link href="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/css/demo.css" rel="stylesheet">-->
        <link href="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/css/common.css" rel="stylesheet">
    <!--[if lt IE 9]>
      <script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
    <![endif]-->
    <link href="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/css/styles.css" rel="stylesheet">
      <link href="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/css/style.css" rel="stylesheet">
      
        
          <link href="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/js/modernizr.custom.72111.js" rel="stylesheet">
...
window.cookieconsent_options = {"message":"Este site utiliza cookies para assegurar-lhe a melhor experiência de navegação no nosso site.","dismiss":" OK !","learnMore":"Saber mais","link":"https://transparencia.pt/politica-de-privacidade/","theme":"dark-bottom"};
</script>
...
<?php query_posts('cat=5'); ?>
          ...
          <div class="rw-words rw-words-1"  >
            ...
            <span style="color:#fff"><a href="https://google.pt" style="color:#fff">REGISTA-TE</a></span>
            <span style="color:#fff"><a href="https://google.pt" style="color:#fff">INICIA SESSÂO</a></span>
            <span style="color:#fff"><a href="https://google.pt" style="color:#fff">REGISTA-TE</a></span>
            <span style="color:#fff"><a href="https://google.pt" style="color:#fff">INICIA SESSÂO</a></span>
            <span style="color:#fff"><a href="https://google.pt" style="color:#fff">REGISTA-TE</a></span>
            <span style="color:#fff"><a href="https://google.pt" style="color:#fff">INICIA SESSÂO</a></span>
  ...
  padding: 2px 15px 2px;" >
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/" ><img alt="" src="https://transparencia.pt/wp-content/themes/wpbootstrap/assets/img/logoRodape.png" style="width: 170px; height: 52px;margin-top:-18px"></a>
        </div>
   ...
   onMouseOut="this.style.color='#999'" style="border-bottom:none;">Temas e projetos</a></li>
   ...
   onMouseOut="this.style.color='#999'">NOTÍCIAS<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <li><a href="/getinvolved/" onMouseOver="this.style.color='#3695d8'"
   onMouseOut="this.style.color='#999'">Destaques</a></li>
              <li><a href="/getinvolved/report/" onMouseOver="this.style.color='#3695d8'"
   onMouseOut="this.style.color='#999'">Últimas</a></li>
              <li><a href="/getinvolved/stayinformed/" onMouseOver="this.style.color='#3695d8'"
   onMouseOut="this.style.color='#999'">Notícias TIAC</a></li>
              <li><a href="/unmask_the_corrupt/" onMouseOver="this.style.color='#3695d8'"
   onMouseOut="this.style.color='#999'">Opinião</a></li>
              <li><a href="/getinvolved/competitions/" onMouseOver="this.style.color='#3695d8'"
   onMouseOut="this.style.color='#999'">Newsletters</a></li>
              <li><a href="/getinvolved/integrityawards/" onMouseOver="this.style.color='#3695d8'"
   onMouseOut="this.style.color='#999'">Vídeos</a></li>
...
-
   ...
   onMouseOut="this.style.color='#999'">Reporta um Caso</a></li>
              <li><a href="<?php echo get_site_url();?>/participa#voluntario" onMouseOver="this.style.color='#3695d8'"
   ...
   onMouseOut="this.style.color='#999'">Apoia-nos</a></li>
          ...
          <li><a href="/donate/" style="color:#FFA500"onMouseOver="this.style.color='#3695d8'"
   onMouseOut="this.style.color='#FFA500'">DONATIVO</a></li>
