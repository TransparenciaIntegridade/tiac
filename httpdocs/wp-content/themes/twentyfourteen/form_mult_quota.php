...
$nome_servidor = $_SERVER['SERVER_NAME'];
   if(isset($_POST['_qf_Main_upload'])){
     ...
     $data_recebimento = date("Y-m-d H:i:s");
      ...
      $wpdb->query("INSERT INTO civicrm_contribution (contact_id,financial_type_id,contribution_page_id,payment_instrument_id,receive_date,total_amount,currency,source,contribution_status_id) VALUES ('$contact_id->id','2','9','4','$data_recebimento','12.00','EUR','Pagamento de Quotas','2')");
