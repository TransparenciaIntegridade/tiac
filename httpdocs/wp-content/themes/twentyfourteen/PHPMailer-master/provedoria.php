<?php
require_once("http://transparencia.pt/wp-content/themes/wpbootstrap/PHPMailer-master/class.phpmailer.php");
include("http://transparencia.pt/wp-content/themes/wpbootstrap/PHPMailer-master/class.gpg.php");
...
*/
 ...
 if(!isset($aceitar) && $aceitar == ""){
  ...
  if($email == true){
    /*$msg= "Por favor preencha o campo 'Em que consiste o problema?";

$message_body = escapeshellarg($message_body);
$gpg_path     = '/usr/local/bin/gpg';
$sender       = 'celso.rodrigues@transparencia.pt';
$recipient    = 'celso.rodrigues@transparencia.pt';
$home_dir     = '/home/tiac';
$user_env     = 'web';
...
fwrite($fp, $data);             // write our string to the pipe
