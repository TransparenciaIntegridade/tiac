...
if(isset($_POST['g-recaptcha-response'])){
  ...
  if($email1 == true){
     ...
     if(empty($erros)){
       ...
       $mail->addAddress("celso.rodrigues@transparencia.pt","Secretariado TIAC");
...
<h3 style="text-align:center;">Envia-nos uma mensagem**</h3>
...
Usa o canal seguro da <a href="//transparencia.pt/o-que-fazemos/#provedoria">Provedoria TIAC- Alerta Anticorrupção </a></i>.
...
<div class="inf_contactos">
<div style="margin-top:5%;margin-left:15%;margin-right:10%;margin-bottom:10%" ><img alt="" src="<?php echo get_site_url();?>/wp-content/themes/wpbootstrap/assets/img/logoc.png" width="200" height="62" /></div>
