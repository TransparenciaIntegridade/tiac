...
set_include_path(
		realpath("http://transparencia.pt/wp-content/themes/wpbootstrap/php-gpg-master/libs/") .
		PATH_SEPARATOR . get_include_path()
);

//require_once 'PHPUnit/Framework/TestCase.php';
require_once 'http://transparencia.pt/wp-content/themes/wpbootstrap/php-gpg-master/libs/GPG.php';
