...
//$ent_id= 23
?>
<body style='font-family: Verdana; font-size: 11pt; vertical-align: none;'>
		<div align='center'style='font-family: Verdana; font-size: 11pt; vertical-align: none;'>
	...
	<td style='font-size: x-small; border-bottom: 1px solid #45829F; background-color: #45829F; color: White; padding: 5px;'  colspan='3'>Pagamento por Multibanco ou Homebanking</td>";
		...
		<tr>";
		<td rowspan='3'><img src='/wp-content/themes/wpbootstrap/assets/img/logoMB.jpg' alt='' /></td>
		<?php 	echo '<h3 style="color:#ef5151;text-align:center;"><b>'.$ent_id.' </b></h3>';	?>
...
$mpdf->SetDisplayMode('fullpage');
	...
	//$html = '<h1>VAI CHUPAR PIROCA PDF NOJENTO</h1>';
	//$html.='<td style="font-size: x-small; font-weight:bold; text-align:left">Entidade: '.$ent_id.'</td>';
