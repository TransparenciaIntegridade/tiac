...
$dias_restantes = $d->diff(new DateTime())->format('%a');  //--> 321


//echo "<p>" .$nome . " " .$apelido . " " .$email . " " .$dias_restantes ."</p>";
...
$message = Swift_Message::newInstance('Mais um ano com a TIAC')
  ->setFrom(array('celso.r.n.rodrigues@gmail.com' => 'TIAC'))
  ->setTo(array($email1 => 'Quotas'))
...
$transport = Swift_SmtpTransport::newInstance('smtp.transparencia.pt', 25)
  ...
  ->setPassword('Tiac2013')
  ;
$email1="transparencia_integridade@hotmail";
/*
You could alternatively use a different transport such as Sendmail or Mail:
