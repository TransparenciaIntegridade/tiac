               ...
               <div id="banner-inner-wrapper">
                ...
                <nav id="menu-drink">
                     <ul>
                        ...
                        <li class="menu-item">
                         <div class="visible-phone">
                            <a href="/#sobre"><i class="fa fa-users  fa-lg" ></i><b style="margin-left:5px">Sobre</b></a>
                             ...
                             <div class="hidden-phone">
                             <a href="/#participa"><i class="fa fa-wrench  fa-2x" style="margin-left:-5px"></i><b style="margin-left:5px">Participar</b></a>
                            </div>
                        ...
                        <li class="menu-item">
                            <a href="/#noticias"><i class="fa fa-rss fa-lg" ></i><b style="margin-left:5px">Noticias</b></a>
                        </li>
                        ...
                        <div class="visible-phone">
                        <li class="menu-item">
                          <a href="#" onClick="alert(' © 2014 TIAC. Todos os direitos reservados. \nMastered by dm@nl@ncers ')"><i class=" fa fa-edit fa-lg"></i><b style="margin-left:5px">Créditos</b></a>
                        </li>
                      </div>
                    </ul>
                </nav>
