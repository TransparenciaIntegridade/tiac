...
function create_talki_page() {
    ...
    $my_post['post_content'] = "Talki forum will be embedded on this page.  If you are having problems, please head to http://help.tal.ki/home/support";
...
function talki_admin_options() {
    ...
    echo <<<STUFF
        <h2>Tal.ki - the easiest way to embed a forum</h2>
