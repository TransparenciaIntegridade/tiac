...
class Endividamento
{
     ...
     * @var string
     *
     * @ORM\Column(name="ano2010", type="string", length=13, nullable=true)
     */
    private $ano2010;
     ...
     * @var string
     *
     * @ORM\Column(name="ano2011", type="string", length=13, nullable=true)
     */
    private $ano2011;
     ...
     * @var string
     *
     * @ORM\Column(name="ano2012", type="string", length=13, nullable=true)
     */
    private $ano2012;
