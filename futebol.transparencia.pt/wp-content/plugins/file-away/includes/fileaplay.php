...
function fileaplay(flg,ids,audiourl,volume){
...
function ssfa_fileaplay($atts) {
	...
	$player_cont .= '<span id="fileaplay_'.$ids.'" class="ssfa-fileaplay-play4 ssfaButton_play" onClick="fileaplay(\'play\',\''.$ids.'\',\''.str_replace("'",'%27',$fileurl).'\',\''.$volume.'\');show_hide(\'play\',\''.$ids.'\');"></span>';
	$player_cont .= '<span id="fileapause_'.$ids.'" class="ssfa-fileaplay-pause4 ssfaButton_stop" onClick="fileaplay(\'stop\',\''.$ids.'\',\'\',\''.$volume.'\');show_hide(\'stop\',\''.$ids.'\');"></span>';	
