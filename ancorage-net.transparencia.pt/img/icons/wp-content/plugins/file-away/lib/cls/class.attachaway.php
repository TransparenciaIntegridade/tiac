...
if(class_exists('fileaway_attributes') && !class_exists('attachaway'))
{
	class attachaway extends fileaway_attributes
	{
		...
		public function sc($atts)
		{
			...
			$thefiles .= "$clearfix<div id='ssfa-meta-container-$uid $mobileclass $class' data-uid='$uid' class='ssfa-meta-container' style='margin: 10px 0 20px; $fadeit $howshouldiputit'>";
